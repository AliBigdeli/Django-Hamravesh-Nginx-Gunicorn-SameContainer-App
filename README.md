...
<h1 align="center">Django3.2 Hamravesh (Nginx,Gunicorn) media serve Template</h1>
<h3 align="center">Sample Project to use hamravesh service provider for django apps which will need disks for media storage</h3>
</div>
<p align="center">
...
```bash
git clone https://github.com/AliBigdeli/Django-Hamravesh-Nginx-Gunicorn-SameContainer-App.git
```
...
``` properties
repo_address: https://github.com/AliBigdeli/Django-Hamravesh-Nginx-Gunicorn-SameContainer-App.git
...
service_port: 80 # which is based on the nginx port
execute_command: leave it empty
```
...
also if you want to serve media files as well you need to add disks for the project. right now we will declare 1 gig for only media files
<div align="center" ><img loading="lazy" style="width:700px" src="./docs/hamravesh-repo-step3-2.png"></div>
